...
import backgroundMusic from '../src/background_music.mp3';
...
function App() {
    ...
    .then(res => {
        console.log(res.data.pre_bid_conference)
        ...
        <h1 className='text-center'><b>Information Board</b></h1>
            ...
            <Row>
                <Col lg={12} className='mt-3' style={{padding: 0}}>
                    <Alert variant='primary' style={{paddingTop: 0, marginBottom: 0, borderRadius: 0, backgroundColor: '#0d0963', padding: 0}}>
                        <h1 className='text-center' style={{marginBottom: 15, color: 'white'}}>
